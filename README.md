...
| :--- | :--- |
| 💼 **Internship** | **Android Software Engineer Intern** @ (주)어떤사람들 <br> *2026.01 ~ (Continuing as Part-time)* |
...
* 🎮 [**HitTheLastOne**](https://hit-the-last-one.vercel.app/) – Interactive game developed with Unity.
* 🏷️ **Name Recommendation (Freelance)** – Developed a name recommendation service website utilizing **OpenAI API** to provide personalized naming solutions based on client requirements.
<br>

# 📚 Studies

* 🏛️ **Hanyang University** – Major in Computer Science & Software (Senior year)
* 📱 **Android Mastery** – Google Official Codelabs (Compose, State Management, Navigation)
* 💡 **Algorithm** – Preparing for coding tests with Python & Kotlin
...
# 🧑‍💻 Contact me
<div style="text-align: left;">
  <a href="mailto:smilechild1005@gmail.com">
